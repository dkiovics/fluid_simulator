#include "gfx2D/simulationGfx2D.h"

using namespace visual;

void SimulationGfx2D::updateParticles()
{
...
void SimulationGfx2D::mouseCallback(double x, double y)
{
...
void SimulationGfx2D::mouseButtonCallback(int button, int action, int mods)
{
	if (!mouseValid)
		return;
...
void SimulationGfx2D::scrollCallback(double xoffset, double yoffset)
{
	if (!mouseValid)
		return;
...
void SimulationGfx2D::handleSimSpecChanged()
{
...
SimulationGfx2D::SimulationGfx2D(std::shared_ptr<renderer::WindowManager> engine, std::shared_ptr<genericfsim::manager::SimulationManager> simulator, int maxParticleNum)
...
void SimulationGfx2D::setNewSimulationManager(std::shared_ptr<genericfsim::manager::SimulationManager> manager) override
{
	simulator = manager;
...
glm::vec2 SimulationGfx2D::getMouseGridPos()
{
	return camera->getWorldPosition(mousePos);
}

void SimulationGfx2D::render() override
{
...
//pos between [0, 1]
void SimulationGfx2D::addSphericalObstacle(glm::vec3 color, float r) override
{
...
//pos between [0, 1]
void SimulationGfx2D::addRectengularObstacle(glm::vec3 color, glm::vec3 size) override
{
...
void SimulationGfx2D::removeObstacle() override
{
...
SimulationGfx2D::~SimulationGfx2D() override
{
